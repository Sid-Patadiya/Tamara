...
const SubscriptionPlanOption1 = (props: any) => {
        ...
        <View
            ...
            {category?.length && typeof category !== 'string'
                ? category?.map((item: any, index: any) => {
                    const isSelected = selectedPlan?.price === item.price;
                    return (
                        <LinearGradient
                            ...
                            <TouchableOpacity
                                ...
                                <View
                                    ...
                                    <View
                                        style={[CommonStyle.rowAlignItems, { marginTop: 10 }]}>
                                        <AssetImage
                                            isLoadFromLocal
                                            source={
                                                isSelected
...
export { SubscriptionPlanOption1 };
